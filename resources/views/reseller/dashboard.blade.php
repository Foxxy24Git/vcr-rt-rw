    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition duration-200 hover:shadow-lg">
            ...
            <div class="max-w-xl rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition duration-200 hover:shadow-lg">
